...
void setup() 
{
  ...
  pauseButton = new SimpleButton("Hold Please", xbutton, MousePaperBottom + 20, font_CB, 20, TextColor, TextHighLight);
  xbutton += 60; 
  ...
  openButton = new SimpleButton("Open File Test", xbutton, ybutton, font_CB, 20, LabelColor, TextHighLight); 
  xbutton += 80;
  ...
  UIMessage = new SimpleButton("Welcome to MoonTattoo! Hold 'h' key for help!", 
...
void draw() {
  ...
  if (debugMode)
  {
    frame.setTitle("MoonTattoo      " + int(frameRate) + " fps");
  }
  ...
  if (doSerialConnect)
  {
    ...
    {    
      ...
      UIMessage.label = "Welcome to MoonTattoo!  Hold 'h' key for help!";
...
void mousePressed() {
  ...
  } else if ( openButton.isSelected() )  
  {
    ...
    selectInput("Select an MoonTattoo (.rrt) file to open:", "fileSelected");  // Opens file chooser
  }
}
